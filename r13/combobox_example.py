...
class ComboBoxWindow(Gtk.Window):
    def __init__(self):
        ...
        countries = ["Austria", "Brazil", "Belgium", "France", "Germany",
                     "Switzerland", "United Kingdom", "United States of Americ",
                     "Uruguay"]
        ...
        country_combo.pack_start(rendered_text, True)
        country_combo.add_attribute(rendered_text, "text", 0)
    ...
    def on_currency_combo_changed(self, combo):
        ...
        if text is None:
            print("Selected: currency={}".format(text))
